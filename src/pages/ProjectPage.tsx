import projectimage from '../assets/projectimage1.png';
    ...
    return (
      ...
      <div className="flex flex-col items-center justify-center mt-40 space-y-10">
        <div className="flex flex-col items-center md:flex-row md:space-x-12">
          <img
            src={projectimage}
            alt="preview do projeto devblog"
            className="w-72 h-44 object-cover rounded-3xl border border-gray-700 shadow"
          />
          <div className="mt-6 md:mt-0 text-center md:text-left">
            ...
            <div className='text-sm pt-3 hover:text-blue-500 w-44'>
        ...
        <div className="flex flex-col items-center md:flex-row md:space-x-12">
          <img
            src={projectimage2}
            alt="preview do projeto dashboard"
            className="w-72 h-44 ml-12 object-cover rounded-3xl border border-gray-700 shadow"
          />
          <div className="mt-6 md:mt-0 text-center md:text-left">
